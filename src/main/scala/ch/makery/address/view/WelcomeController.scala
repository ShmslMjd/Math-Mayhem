...
@sfxml
class WelcomeController(private val startBtn: Button, private val abtBtn: Button, private val quitBtn: Button) {
  def getStarted(): Unit = {
    //show the gameview
    MainApp.showGame()
  }
  ...
  def showAbout(): Unit = {
    val alert = new Alert(AlertType.Information) {
      ...
      contentText = "Math Mayhem is a fun and engaging math training game that helps you " +
        ...
        "\n3. To make the game more challenging. We will decrease your time and score if you select the wrong answer. But" +
